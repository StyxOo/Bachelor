...
Scales are a way to convert between two data ranges. Some scales can even convert between two data types. Scales can be found in many places. For example converting percentages of correct answers in a test, continuous data, to the appropriate grade, ordinal data. Or the scale factor of maps and model-kits, which uses only numerical data.
